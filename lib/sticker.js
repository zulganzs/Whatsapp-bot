...
async function addExif(webpSticker, packname, author, categories = [], extra = {}) {
	...
	const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'link-group-bot': 'https://chat.whatsapp.com/GlOdC4SCgEmLkylQEqbHve', 'link-script-github': 'https://github.com/zulganz', ...extra };
